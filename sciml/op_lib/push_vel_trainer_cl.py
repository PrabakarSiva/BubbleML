...
class PushVelTrainerCl:
    ...
    def push_forward_prob(self, epoch, max_epochs):
        ...
        """
        cur_iter = epoch * len(self.train_dataloaders[epoch])
        tot_iter = max_epochs * len(self.train_dataloaders[epoch])
    ...
    def train_step(self, epoch, max_epochs):
        ...
        for iter, (coords, temp, vel, dfun, temp_label, vel_label) in enumerate(self.train_dataloaders[epoch]):
            ...
            global_iter = epoch * len(self.train_dataloaders[epoch]) + iter
